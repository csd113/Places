...
Places is the standalone home for Liminal, the game described below. The stable
Vitrallis application ID remains `io.vitrallis.liminalrust` for existing
PocketCHIP installations.
